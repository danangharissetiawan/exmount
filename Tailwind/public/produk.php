    ...
    <div class="container">
        <div class="w-full px-4">
            <div class="max-w-xl mx-auto text-center mb-16">
                <h4 class="font-semibold text-lg mb-2 text-[#E78F37]">Product</h4>
            ...
            <?php while ($perproduk = $ambil->fetch_assoc()) { ?>
                <div class="w-full px-4 lg:w-1/2 xl:w-1/4">
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg h-full">
                        <img src="foto_mount/<?php echo $perproduk['foto_mount1']; ?>" class="w-full" alt="">
                        <div class="py-8 px-6">
                            ...
                            <a href="detail.php?id=<?php echo $perproduk['id_mount']; ?>" class="font-medium text-sm text-white bg-[#F3B15F] py-3 px-6 rounded-lg hover:opacity-80">detail</a>
