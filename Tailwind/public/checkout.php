...
<section class="py-12 bg-slate-100">
    <div class="container">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($_SESSION["keranjang"] as $id_mount => $jumlah) : ?>
                                    ...
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="px-6 py-4"><input class="bg-slate-200 p-1 rounded-lg outline-slate-100" type="date" name="tanggalPendakian" id=""></td>
        ...
        <div class="w-full px-4 py-3">
            <div class="mx-auto">
                <div class="p-4 bg-white items-center">
                    <p class="font-bold text-lg mb-3">Metode Pembayaran Tranfer Bank</p>
